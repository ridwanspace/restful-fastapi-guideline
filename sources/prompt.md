## Create new
<version_1>
please split sections at @sources/fastapi_guidelines/enterprise_fastapi_guidelines.md into dedicated subfolder/page.mdx into @app/docs/05_enterprise, make sure the subfolder names are in correct order since the order is defined by the subfolder name, follow the orders based on sections at @sources/fastapi_guidelines/enterprise_fastapi_guidelines.md, do not change any contents there (just keep the original). As reference, you can view @app/docs/02_foundation/
...
# LLM Prompt: Convert Documentation to Vue.js Excellence Standard
