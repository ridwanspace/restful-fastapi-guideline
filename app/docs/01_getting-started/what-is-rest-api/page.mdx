...
Now that you understand what APIs and REST are all about, you're ready to:

1. **[Install FastAPI](/docs/01_getting-started/installation)** - Set up your development environment
2. **[Build Your First API](/docs/01_getting-started/first-api)** - Create a working API step-by-step
