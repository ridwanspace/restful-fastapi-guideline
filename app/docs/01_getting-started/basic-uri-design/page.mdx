...
1. **✅ Use nouns, not verbs** - Let HTTP methods handle actions
2. **✅ Use plural forms** - Consistent collection naming
3. **✅ Use lowercase with hyphens** - Web-standard formatting
4. **✅ Keep URLs predictable** - Similar resources should have similar patterns
5. **✅ Use query parameters for filtering** - Keep URLs clean
6. **✅ Limit nesting depth** - Usually 2-3 levels maximum
7. **✅ Be consistent** - Same patterns throughout your API
...
- **[HTTP Methods](/docs/01_getting-started/basic-http-methods)** - Master GET, POST, PUT, and DELETE
- **[Your First Complete API](/docs/01_getting-started/your-first-api)** - Build a complete API using these principles
