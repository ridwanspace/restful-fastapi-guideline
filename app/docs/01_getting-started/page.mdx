...
### 1. [Installing FastAPI](/docs/01_getting-started/installation)
...
### 2. [Your First Complete API](/docs/01_getting-started/your-first-api)
...
### 4. [What is REST & HTTP Methods](/docs/01_getting-started/basic-http-methods)
