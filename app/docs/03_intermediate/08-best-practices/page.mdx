...
graph TB
    ...
    style LB fill:#e1f5fe,color:#3b3b3b
    style B1 fill:#e8f5e8,color:#3b3b3b
    style B2 fill:#e8f5e8,color:#3b3b3b
    style B3 fill:#e8f5e8,color:#3b3b3b
    style G1 fill:#fff3e0,color:#3b3b3b
    style G2 fill:#fff3e0,color:#3b3b3b
    style G3 fill:#fff3e0,color:#3b3b3b
```
