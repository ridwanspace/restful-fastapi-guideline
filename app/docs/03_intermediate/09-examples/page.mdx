...
graph LR
    ...
    style EC fill:#e1f5d1,stroke:#4caf50,stroke-width:2px,color:#3b3b3b
    style SM fill:#ffd4a3,stroke:#ff9800,stroke-width:2px,color:#3b3b3b
    style AN fill:#d4e6ff,stroke:#2196f3,stroke-width:2px,color:#3b3b3b
```
