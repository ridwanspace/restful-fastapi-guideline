...
graph TB
    ...
    style GRAF fill:#e8f5e8,color:#3b3b3b
    style ALERT fill:#ffebee,color:#3b3b3b
```
...
graph TB
    ...
    style EXEC fill:#e8f5e8,color:#3b3b3b
    style ALERTS fill:#ffebee,color:#3b3b3b
    style INSIGHTS fill:#e3f2fd,color:#3b3b3b
```
