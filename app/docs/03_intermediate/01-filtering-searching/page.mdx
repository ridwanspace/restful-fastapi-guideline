...
flowchart TD
    ...
    style A fill:#ffcdd2,color:#3b3b3b
    style B fill:#f8bbd9,color:#3b3b3b
    style C fill:#e1bee7,color:#3b3b3b
    style D fill:#d1c4e9,color:#3b3b3b
    style E fill:#fff3e0,color:#3b3b3b
    style F fill:#e8f5e8,color:#3b3b3b
    style G fill:#e3f2fd,color:#3b3b3b
...
graph TD
    ...
    style C fill:#e1bee7,color:#3b3b3b
    style D fill:#d1c4e9,color:#3b3b3b
    style E fill:#c5cae9,color:#3b3b3b
```
