...
sequenceDiagram
    ...
    Note over Client,Server: Polling: The 'Are we there yet?' approach
    ...
    Note over Client,Server: Webhooks: The 'Don't call us, we'll call you' approach
...
graph LR
    ...
    YourApp -- CRUD Operations --> DB[(Database webhook_subscriptions)]
