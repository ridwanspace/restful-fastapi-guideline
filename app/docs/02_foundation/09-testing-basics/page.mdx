...
graph TD
    ...
    style N fill:#c8e6c9,color:#3b3b3b
    style M fill:#fff3e0,color:#3b3b3b
```
...
```mermaid
graph TD
    %% Testing Pyramid: Detective Investigation Levels
    
    N_Top["🔬 Unit Tests (70%)<br/>Individual Evidence Analysis<br/>Fast • Isolated • Specific"]
    
    N_Middle["🔗 Integration Tests (20%)<br/>Connecting Evidence Pieces<br/>Medium Speed • Component Groups"]
    
    N_Bottom["🌐 API Tests (10%)<br/>Complete Case Investigation<br/>Slower • Full System • User Experience"]
...
graph LR
    ...
    style B fill:#c8e6c9,color:#3b3b3b
    style C fill:#c8e6c9,color:#3b3b3b
    style D fill:#c8e6c9,color:#3b3b3b
